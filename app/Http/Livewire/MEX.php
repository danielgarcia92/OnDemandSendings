...
class MEX extends Component
{
    ...
    {
        if (Auth::user()->rol == 'admin' || Auth::user()->rol == 'jt' || Auth::user()->rol == 'ccv' || Auth::user()->rol == 'mex'  || Auth::user()->rol == 'acdm' ) {
            try{
                ...
                $this->flights1 = \DB::table('AIMSPROD.VIV.dbo.LEGMAIN AS FL')
                    ->select(['FL.REG'
                        , \DB::raw("CASE WHEN (SELECT TOP 1 FL2.FLT FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." - 1 AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) IS NULL THEN 'HGR' ELSE (SELECT TOP 1 CAST(FL2.FLT AS varchar) FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." - 1 AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) END 'Llegada'")
                        , \DB::raw("CASE WHEN (SELECT TOP 1 FL2.DEP FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." - 1 AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) IS NULL THEN 'HGR' ELSE (SELECT TOP 1 CAST(FL2.DEP AS varchar) FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." - 1 AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) END 'Origen'")
                        , \DB::raw("(SELECT TOP 1 CONVERT(VARCHAR(16),VIV_CORE.dbo.GetStartTimeStrViv_V5(FL2.DAY, FL2.STA, FL2.ARR), 120) FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." - 1 AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) 'STA'")
                        , 'FL.FLT'
                        , 'FL.ARR'
                ...
                $this->flights2 = \DB::table('AIMSPROD.VIV.dbo.LEGMAIN AS FL')
                    ->select(['FL.REG'
                        ...
                        , \DB::raw("(SELECT TOP 1 CONVERT(VARCHAR(16),VIV_CORE.dbo.GetStartTimeStrViv_V5(FL2.DAY, FL2.STA, FL2.ARR), 120) FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD2->DATE." - 1 AND ".$OQAD2->DATE." + 1 AND FL2.REG = FL.REG AND FL2.ARR = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD < FL.STD) OR (FL2.DAY < FL.DAY)) AND CARRIER = 1 AND CANCELLED = 0 ORDER BY DAY DESC, STD DESC) 'STA'")
                        , 'FL.FLT'
                        , 'FL.ARR'
                        , \DB::raw('CONVERT(VARCHAR(16),VIV_CORE.dbo.GetStartTimeStrViv_V5(FL.DAY, FL.STD, FL.DEP), 120) STD')
                    ])
                ...
                $this->flightsHGR1 = \DB::table('AIMSPROD.VIV.dbo.LEGMAIN AS FL')
                    ...
                    ->where('FL.CANCELLED', '=', 0)
                    ->whereBetween('FL.DAY', [$OQAD1->DATE, $OQAD1->DATE + 1])
                    ->whereNull(\DB::raw("(SELECT TOP 1 FL2.FLT FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD1->DATE." AND ".$OQAD1->DATE." + 1 AND FL2.REG = FL.REG AND FL2.DEP = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD > FL.STD) OR (FL2.DAY > FL.DAY)) AND ((FL2.DAY > ".$OQAD1->DATE." OR FL2.STD > 300) AND (FL2.DAY < ".$OQAD1->DATE." + 1 OR FL2.STD < 400)) AND CANCELLED = 0 ORDER BY FL2.DAY, FL2.STD)"))
                ...
                $this->flightsHGR2 = \DB::table('AIMSPROD.VIV.dbo.LEGMAIN AS FL')
                    ...
                    ->where('FL.CANCELLED', '=', 0)
                    ->whereBetween('FL.DAY', [$OQAD2->DATE, $OQAD2->DATE + 1])
                    ->whereNull(\DB::raw("(SELECT TOP 1 FL2.FLT FROM AIMSPROD.VIV.dbo.LEGMAIN FL2 WITH (NOLOCK) WHERE FL2.DAY BETWEEN ".$OQAD2->DATE." AND ".$OQAD2->DATE." + 1 AND FL2.REG = FL.REG AND FL2.DEP = 'MEX' AND ((FL2.DAY = FL.DAY AND FL2.STD > FL.STD) OR (FL2.DAY > FL.DAY)) AND ((FL2.DAY > ".$OQAD2->DATE." OR FL2.STD > 300) AND (FL2.DAY < ".$OQAD2->DATE." + 1 OR FL2.STD < 400)) AND CANCELLED = 0 ORDER BY FL2.DAY, FL2.STD)"))
