        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if ( Auth::user()->rol == 'admin' || Auth::user()->rol == 'jt' || Auth::user()->rol == 'ccv' )
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('FW') }}">
                            {{ __('FWD') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('FWACMI') }}">
                            {{ __('FWD ACMI') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                @endif
                @if ( Auth::user()->rol == 'asa' || Auth::user()->rol == 'gdl' || Auth::user()->rol == 'mex' || Auth::user()->rol == 'nlu' || Auth::user()->rol == 'acdm' )
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-jet-nav-link>
                ...
                @endif
                @if ( Auth::user()->rol == 'mex'  || Auth::user()->rol == 'acdm' )
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('MEX') }}">
                            {{ __('MEX') }}
                        </x-jet-nav-link>
                ...
                @endif
                @if ( Auth::user()->rol == 'nlu'  || Auth::user()->rol == 'acdm' )
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('NLU') }}">
                            {{ __('NLU') }}
                        </x-jet-nav-link>
